...
export default function InletPumpScreen() {
  ...
  const fetchActivityLogs = async () => {
    ...
    try {
      ...
      const equipmentId = await AsyncStorage.getItem('inletPumpId');
      if (!equipmentId) {
        ...
        <View style={styles.card}>
          ...
          <View style={styles.statusCardContent}>
              ...
              <View style={styles.statusRow}>
                ...
                <View
                  style={[
                    ...
                    currentState === 'OFF' && styles.statusDotOff,
                  ]}
                />
                ...
                <Text
                  style={[
                    ...
                    currentState === 'OFF' && styles.statusTextOff,
                  ]}
                >
                  {currentState === 'ON' ? 'Running' : 'Ready'}
                </Text>
            ...
            <View
              style={[
                styles.offBadge,
                currentState === 'ON' && styles.onBadge,
              ]}
            >
              ...
              <Text
                style={[
                  styles.offBadgeText,
                  currentState === 'ON' && styles.onBadgeText,
                ]}
              >
