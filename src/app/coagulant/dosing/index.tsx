...
export default function CoagulantSystemScreen() {
  ...
  const fetchStageStatus = async () => {
    ...
    try {
      ...
      console.log('Coagulation Dosing Stage ID:', stageId);


      if (!stageId) {

        console.log('No Coagulation Dosing Stage ID found');
  ...
  const fetchProcessLogs = async () => {
    ...
    try {
      ...
      if (!stageId || isNaN(Number(stageId))) {
        ...
        console.log('No valid Coagulation Dosing Stage ID found');
  ...
  const handleStartSystem = async () => {
    ...
    try {
      ...
      console.log(
        ...
        'Start Coagulation Dosing Stage ID:',
