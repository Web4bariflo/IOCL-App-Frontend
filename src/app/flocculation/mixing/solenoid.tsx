...
import { turnOnValve, turnOffValve, getEquipmentManualLogs, } from '../../../api/flocculationApi';
...
export default function SolenoidScreen() {
    ...
    const fetchManualLogs = async () => {
        try {
            ...
            console.log('Failed to fetch manual logs:', error);
        } finally {
    ...
    const handleOpenValve = async () => {
        try {
            ...
            if (!stageId || !valveId) {
                console.log('Stage ID or Valve ID not found');
                return;
            }
            ...
            if (response?.success) {
                ...
                if (startedAt) {
                    ...
                    console.log('Formatted Open Time:', formattedTime);
                ...
                // Get latest 3 logs from API
                await fetchManualLogs();
            }
        } catch (error) {
            console.log('Failed to open valve:', error);
        } finally {
            setLoading(false);
        }
    };
        ...
        try {
            ...
            if (response?.success) {
                ...
                if (durationSeconds !== null && durationSeconds !== undefined) {
                    ...
                    setOpenDuration(durationText.trim());
                }
            ...
            console.log('Failed to close valve:', error);
        } finally {
            setLoading(false);
        }
    };
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.card}>
                    ...
                    {/* After Close: Show Close Time + Open Duration */}
                    {closeTime && (
                        <>
                            <View style={styles.scheduleRow}>
                                <View style={styles.scheduleLabelContainer}>
