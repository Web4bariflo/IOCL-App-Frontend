...
export default function SolenoidScreen() {
    ...
    const fetchManualLogs = async () => {
        try {
            ...
            console.log('Desludging Stage ID:', stageId);
            console.log('Desludging Solenoid ID:', valveId);

            if (!valveId) {
                console.log(
                    'Desludging Solenoid ID not found'
                );
                return;
            }
            ...
            console.log(
                'Desludging Solenoid Manual Logs Response:',
                response
            );
            ...
            console.log(
                'Failed to fetch Desludging Solenoid manual logs:',
                error
            );
        } finally {
    ...
    const handleOpenValve = async () => {
        try {
            ...
            if (!stageId || !valveId) {
                console.log(
                    'Desludging Stage ID or Solenoid ID not found'
                );
                return;
            }
            ...
            console.log(
                'Desludging Solenoid ON Response:',
                response
            );
            ...
            console.log(
                'Failed to open Desludging solenoid:',
                error
            );
        } finally {
            setLoading(false);
    ...
    const handleCloseValve = async () => {
        try {
            ...
            console.log(
                'Desludging Solenoid OFF Response:',
                response
            );
            ...
            console.log(
                'Failed to close Desludging solenoid:',
                error
            );
        } finally {
            setLoading(false);
